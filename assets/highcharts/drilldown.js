...
(function(n) {
    "object" === typeof module && module.exports ? module.exports = n : "function" === typeof define && define.amd ? define(function() {
        return n
    }) : n("undefined" !== typeof Highcharts ? Highcharts : void 0)
})(function(n) {
    (function(e) {
        var n = e.animObject,
            w = e.noop,
        ...
        e.addEvent(l, "beforeShowResetZoom", function() {
            if (this.drillUpButton) return !1
        });
        e.addEvent(l, "render", function() {
        ...
        p.prototype.animateDrilldown = function(a) {
            var b = this,
                c = this.chart,
                d = c.drilldownLevels,
                f, e = n(c.options.drilldown.animation),
                g = this.xAxis,
                m = c.styledMode;
