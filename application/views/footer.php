...
<!-- /.content-wrapper -->
  <footer class="main-footer">
    <div class="pull-right hidden-xs">
      <b>Design By</b> <a href=""><b>Akhmad Afandik</b></a>
    </div>
    <strong>Copyright &copy; 2019 - <?php echo date('Y'); ?> <a href="">Wisata Jember</a></strong>. All Rights Reserved
  </footer>
...
<script src="<?php echo base_url()?>assets/slide/js/jquery.min.js"></script>
<script src="<?php echo base_url()?>assets/slide/js/bootstrap.min.js"></script>
<script src="<?php echo base_url()?>assets/slide/js/slider.min.js"></script>
